...
/**
 * Write a description of class Vida_2_e_meio here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Vida_2_e_meio extends Vidas
{
    /**
     * Act - do whatever the Vida_2_e_meio wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    private GreenfootImage imageCoracoes;
    public Vida_2_e_meio()
    {
